...
The tidytopics package is a toolkit for topic modeling and analysis of topic models in R. The main focus is to facilitate pre-processing, post-processing and analysis of topic models. It does not contain any samplers for topic models (yet). For the topic model notation used throughout this package, see the notation section below.
...
- **Bayesian Checking of Topic Models**
...
See `?top_terms` for other ways of 
